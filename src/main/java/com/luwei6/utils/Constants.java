...
public final class Constants {
    ...
    public static final long NULL_LONG = -9999999999999998L; // -9223372036854775808L; ǰ̨JAVASCRIPTû����ô����?
    ...
    public static final Date EXP_DATE_DATE_TYPE = DateUtilBase.string2SQLDate(EXP_DATE, EXP_DATE_FORMAT);
    ...
    public static int TELE_SYSTEM_STAFF_ID = -2;

    public static String TELE_SYSTEM_STAFF_CODE = "-2";

    public static String BILLCYCLE_STATE_AVAIL = "50E";

    public static String BILLCYCLE_STATE_STRIKE = "50F";

    public static String BILLCYCLE_STATE_DURATION = "50A";

    public static String BILLCYCLE_STATE_COUNT = "50D";

    public static final String EFF_TYPE_A = "82A";

    public static final String EFF_TYPE_B = "82B";

    public static String DEFAULT_PASSWD = "000000";

    public static String ACTION_INSTALL = "A1";

    public static String ACTION_REMOVE = "A5";

    public static String ACTION_DISMANTLE = "A8";

    public static String ACTION_CHANGE_ACCT_RELATION = "B1";

    public static String ACTION_TRANSFER = "B2";

    public static String ACTION_STOP = "B3";

    public static String ACTION_RECOVER = "B5";

    public static String ACTION_CHANGE_SERV_PRODUCT = "B6";

    public static String ACTION_CHANGE_PRODUCT_OFFER = "B7";

    public static String ACTION_CHANGE_INFO = "B9";

    public static String ACTION_STOP_AND_KEEP_NUM = "C2";

    public static String ACTION_STOP_BEFORE_REMOVE = "C5";

    public static String AGREEMENT_STATE_COMPLETED = "27A";

    public static String AGREEMENT_STATE_EXECUTING = "27B";

    public static String SOURCE_CUST_APPLY = "0";

    public static String SOURCE_STAFF_OPERATE = "1";

    public static String OBJ_TYPE_ACCT = "5BA";

    public static String OBJ_TYPE_CUST = "5BB";

    public static String OBJ_TYPE_SERV = "5BC";

    public static String SINGLE_CHOICE_INPUT = "98A";

    public static String MUTI_CHOICE_INPUT = "98B";

    public static String TEXT_INPUT = "98C";

    public static String PRODUCT_CATALOG_TYPE = "12A";

    public static final int AUTO_BATCH = 1;

    public static String SERV_GRADE_A = "01";

    public static String SERV_GRADE_B = "03";

    public static String SERV_GRADE_C = "04";

    public static String SERV_GRADE_D = "02";

    public static String UPDATE_FLAG_0 = "0";

    public static String UPDATE_FLAG_1 = "1";

    public static String REGION_TYPE_C = "3";

    public static String REGION_TYPE_E = "7";
